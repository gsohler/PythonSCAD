...
# Set Color        
    ...
    def buttonpress(self,glarea, event):
        x= glarea.get_allocation()
        rect = glarea.get_allocation()
    ...
    def buttonrelease(self,glarea, event):
        if event.button == 1:
    ...
    def pointermotion(self, glarea, event):
    ...
    def scrollevent(self, glarea, event):
        print("scrollevent")
